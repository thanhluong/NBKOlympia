...
def questionDirectoryPath(instance, filename):
    ...
    """
    return "khoidong1/{}/{}".format(instance.questionID, filename)


class KhoiDong1Question(models.Model):
    """
    Model for question in Khoi Dong 1 round
    """
    ...
    def __str__(self):
        return "Khởi động - Gói 1: Câu hỏi {}".format(self.questionID)