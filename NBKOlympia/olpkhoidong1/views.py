...
from .forms import KhoiDong1QuestionForm
...
class NewQuestion(generic.CreateView):
    ...
    form_class = KhoiDong1QuestionForm
    success_url = reverse_lazy("newKhoiDong1Question")
...
def toDict(question: KhoiDong1Question):
    """
...
def getQuestions(request):
    ...
    questions = [toDict(question) for question in KhoiDong1Question.objects.all().order_by("questionID")]

    return render(request, template_name="khoidong/olpkhoidong.html", context=dict(questions=questions))
